...
{
  "artifactId": "champcity-ai/phase-03/implementer_report/WC08-REPAIR05",
  "artifactType": "implementer_report",
  "createdAt": "2026-07-14T00:00:00.000Z",
  "jsonPath": "planning/phases/phase-03/Implementer_Reports/IMPLEMENTER_REPORT_WC08-REPAIR05_architect_review_route_and_repair_work_card_association.json",
  "markdownPath": "planning/phases/phase-03/Implementer_Reports/IMPLEMENTER_REPORT_WC08-REPAIR05_architect_review_route_and_repair_work_card_association.md",
  ...
  "relationships": {
    "children": [],
    "expectedOutputs": [
      "champcity-ai/phase-03/architect_review/WC08-REPAIR05"
    ],
    "sources": [
...
# Implementer Report - WC08-REPAIR05 Architect Review Route and Repair Work Card Association
...
- binds the exact associated Implementer Report `IMPLEMENTER_REPORT_WC08-REPAIR04_controlled_route_recovery_and_accurate_route_evidence_authority.md`;
...
- preserves the canonical `Implementer_Reports` storage while presenting Implementer-facing terminology.
...
1. `WorkflowRouterShell.tsx` mapped the `architect-review` workflow state and `architect_review_of_implementer_report_required` action directly to `implementer-report-capture`. The screen therefore operated as Implementer Report Capture even though the controlling action belonged to the Architect.
...
- Implementer Report filename preview now uses the compatibility association reader, so selecting a repair Work Card does not reproduce the strict-schema failure.
