# Builder Report: WC07 Artifact Review Workspace
...
- Primary labels come from safe filename stems with compatibility prefixes such as `BUILDER_REPORT_`, `ARCHITECT_REVIEW_`, `VALIDATION_REPORT_`, and `REPAIR_PROMPT_` removed.
