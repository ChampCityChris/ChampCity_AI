...
- Repair task: REPAIR_WC01_add_project_intake_capture
- Selected Work Card ID: WC01
- Selected Work Card title: Add Project Intake capture
- Phase: phase-02
- Associated Implementer Report: BUILDER_REPORT_WC01_add_project_intake_capture.md
- Validation record: VALIDATION_REPORT_WC01_add_project_intake_capture_2.json
...
- Read the validation record `VALIDATION_REPORT_WC01_add_project_intake_capture_2.json`.
...
Expected report name: `BUILDER_REPORT_REPAIR_WC01_add_project_intake_capture.md`
