...
- WC08 artifact authority risk: draft next-phase planning artifacts can be mistaken for active phase scope unless Project Roadmap, Phase Map, Phase Planning Documents, Work Card Plans, Formal Work Cards, Implementer Prompts, reports, validation, and closeout each show their distinct authority.
