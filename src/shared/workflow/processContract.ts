...
export const lockedProcessContract: readonly ProcessContractItem[] = [
  ...
  },
  {
    ...
    conditionalSourceRequirements: [],
    expectedOutput: output("repository_reconciliation"),
    routes: { success: "project_mapping", failure: "project_interview", repair: "project_interview" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("reconciliation_review", "reconciliation_review_required", "plan", "architect", "repository-reconciliation", "repository_reconciliation", "project_mapping_required", "project_interview_required", "project_interview_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "architect",
    requiredSourceAuthority: [pair("project_intake"), pair("architect_interview"), pair("repository_reconciliation")],
    conditionalSourceRequirements: [],
    expectedOutput: output("roadmap"),
    routes: { success: "operator_project_approval", failure: "project_mapping", repair: "project_mapping" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("project_mapping", "project_mapping_required", "plan", "architect", "project-mapping", "roadmap", "operator_project_approval_required", "project_mapping_required", "project_mapping_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "operator",
    requiredSourceAuthority: [pair("project_planning"), pair("repository_reconciliation"), pair("roadmap")],
    conditionalSourceRequirements: [],
    expectedOutput: output("project_approval"),
    routes: { success: "phase_mapping", failure: "project_mapping", repair: "project_mapping" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("operator_project_approval", "operator_project_approval_required", "plan", "operator", "operator-project-approval", "project_approval", "phase_mapping_required", "project_mapping_required", "project_mapping_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "architect",
    requiredSourceAuthority: [pair("project_approval"), pair("roadmap")],
    conditionalSourceRequirements: [],
  ...
  },
  {
    ...
    expectedOutput: output("phase_approval"),
    routes: { success: "work_card_loop", failure: "phase_mapping", repair: "phase_mapping" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("operator_phase_approval", "operator_phase_approval_required", "plan", "operator", "operator-phase-approval", "phase_approval", "work_card_authoring_required", "phase_mapping_required", "phase_mapping_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "operator",
    requiredSourceAuthority: [pair("phase_approval"), pair("work_card_plan")],
    conditionalSourceRequirements: [],
    ...
    runtimeActions: [
      ...
      runtimeAction("work_card_loop", "operator_work_card_approval_required", "build", "operator", "operator-work-card-approval", "work_card_approval", "implementer_execution_required", "candidate_disposition_required", "work_card_authoring_required"),
      ...
      runtimeAction("work_card_loop", "operator_validation_required", "prove", "operator", "operator-validation", "validation_report", "work_card_authoring_required", "architect_disposition_required", "architect_disposition_required"),
      runtimeAction("work_card_loop", "architect_disposition_required", "prove", "architect", "architect-disposition", "architect_disposition", "operator_validation_required", "repair_work_card_required", "repair_work_card_required"),
  ...
  },
  {
    ...
    conditionalSourceRequirements: [],
    expectedOutput: output("phase_closeout_approval"),
    routes: { success: "roadmap_update", failure: "phase_closeout", repair: "phase_closeout" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("operator_phase_closeout_approval", "operator_phase_closeout_approval_required", "prove", "operator", "operator-closeout-approval", "phase_closeout_approval", "roadmap_update_required", "phase_closeout_required", "phase_closeout_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "architect",
    requiredSourceAuthority: [pair("phase_closeout_approval"), pair("roadmap")],
    conditionalSourceRequirements: [],
    expectedOutput: output("roadmap"),
    routes: { success: "next_phase_activation", failure: "roadmap_update", repair: "roadmap_update" },
    advancesWorkflowState: true,
    runtimeActions: [runtimeAction("roadmap_update", "roadmap_update_required", "prove", "architect", "roadmap-update", "roadmap", "next_phase_activation_required", "roadmap_update_required", "roadmap_update_required")],
  },
  {
    ...
    parentProcessId: null,
    owner: "operator",
    requiredSourceAuthority: [pair("roadmap")],
    conditionalSourceRequirements: [],
  ...
  ...([
    ...
    ["project_roadmap", "Project Roadmap", "project_mapping", "architect", "roadmap"],
