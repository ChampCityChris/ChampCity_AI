...
export interface ImplementerExecutionPacketSupportingArtifact {
  fileName: string;
  content: string;
}

export interface ImplementerExecutionPacketSupportingArtifacts {
  workCardMarkdown?: ImplementerExecutionPacketSupportingArtifact;
  architectPrompt?: ImplementerExecutionPacketSupportingArtifact;
  riskReview?: ImplementerExecutionPacketSupportingArtifact;
  priorImplementerReport?: ImplementerExecutionPacketSupportingArtifact;
}

export interface ImplementerExecutionPacketSupportingArtifactFileNames {
  workCardMarkdown?: string;
  architectPrompt?: string;
  riskReview?: string;
  priorImplementerReport?: string;
}

export interface ImplementerExecutionPacketRequest {
  phase: string;
  fileName: string;
  supportingArtifactFileNames?: ImplementerExecutionPacketSupportingArtifactFileNames;
}

export interface ImplementerExecutionPacketArtifactOption {
  fileName: string;
  label: string;
  isDefaultMatch: boolean;
}

export interface ImplementerExecutionPacketArtifactOptions {
  workCardMarkdown: ImplementerExecutionPacketArtifactOption[];
  architectPrompts: ImplementerExecutionPacketArtifactOption[];
  riskReviews: ImplementerExecutionPacketArtifactOption[];
  priorImplementerReports: ImplementerExecutionPacketArtifactOption[];
}

export interface InvalidImplementerExecutionPacketArtifactFile {
  folder: string;
  fileName: string;
  errorMessages: string[];
}

export interface ImplementerExecutionPacketArtifactListResult {
  ok: boolean;
  workCard?: WorkCard;
  options?: ImplementerExecutionPacketArtifactOptions;
  defaultSelections?: ImplementerExecutionPacketSupportingArtifactFileNames;
  notes?: string[];
  invalidFiles?: InvalidImplementerExecutionPacketArtifactFile[];
  errorMessages?: string[];
}

export interface ImplementerExecutionPacketPreviewResult {
  ok: boolean;
  prompt?: string;
  workCard?: WorkCard;
  sourceFileName?: string;
  selectedArtifactFileNames?: ImplementerExecutionPacketSupportingArtifactFileNames;
  hasHighRiskContext?: boolean;
  hasRiskReviewSelected?: boolean;
  errorMessages?: string[];
}

export interface ImplementerExecutionPacketSaveResult extends ImplementerExecutionPacketPreviewResult {
  markdownPath?: string;
...
export const implementerExecutionPacketHighRiskWarning =
...
export const implementerExecutionPacketNoRiskReviewWarning =
...
export const standardImplementerValidationCommands = [
  "npm run typecheck",
  "npm run build",
  "npm test",
...
export function renderImplementerExecutionPacket(
  workCard: WorkCard,
  ...
  const reportFileName = buildImplementerReportFileName(workCard);
  ...
  return [
    ...
    "",
    `Required report folder: \`planning/phases/${workCard.phase}/Implementer_Reports/\``,
    "",
    "Canonical storage: Implementer Reports use the `Implementer_Reports` folder and `IMPLEMENTER_REPORT_*` filenames.",
    "",
    "Required report filename pattern: `IMPLEMENTER_REPORT_<work_card_id>_<slug>.md`",
    "",
...
export function buildImplementerExecutionPacketFileName(workCard: WorkCard): string {
  return `IMPLEMENTER_EXECUTION_PACKET_${buildWorkCardFileStem(workCard.workCardId, workCard.title)}.md`;
}

export function buildImplementerReportFileName(workCard: WorkCard): string {
...
function renderRiskReviewSummary(
  riskReview: ImplementerExecutionPacketSupportingArtifact | undefined,
  hasHighRiskContext: boolean,
): string[] {
  if (!riskReview) {
    return [implementerExecutionPacketNoRiskReviewWarning];
  }
  ...
  if (hasHighRiskContext) {
    lines.push("", implementerExecutionPacketHighRiskWarning);
  }
...
function renderSupportingArtifactContext(
  ...
  const sections = [
    ...
    renderArtifactSection(
      ...
      supportingArtifacts.priorImplementerReport,
    ),
...
function renderArtifactSection(
  heading: string,
  artifact: ImplementerExecutionPacketSupportingArtifact | undefined,
): string[] {
  if (!artifact) {
    return [];
  }
...
function selectedArtifactLabels(
  ...
  if (supportingArtifacts.priorImplementerReport) {
    labels.push(
      `Prior Implementer Report: \`${supportingArtifacts.priorImplementerReport.fileName}\``,
    );
  }
