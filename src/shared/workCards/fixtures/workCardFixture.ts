...
export const workCardFixture: WorkCard = {
  workCardId: "WC01",
  ...
  problem:
    "ChampCity A/I needs a durable, structured Work Card model before UI capture, Architect prompts, risk routing, or Implementer handoff features can be built.",
  goal:
  ...
  userOutcome:
    "The Operator and Architect can reference a concrete Work Card artifact, and future Implementer prompts can start from structured Work Card data instead of loose chat context.",
  scope: [
    ...
    "Add a Markdown renderer with durable human-readable headings and an Implementer Handoff Prompt section.",
    ...
    "Create a WC01 Implementer Report in `planning/phases/phase-01/Implementer_Reports/`.",
  ],
  outOfScope: [
  ...
  requirements: [
    ...
    "Generate an Implementer Handoff Prompt from structured Work Card fields.",
  ...
  acceptanceCriteria: [
    ...
    "Rendered Markdown includes `## Implementer Handoff Prompt`.",
  ...
  risks: [
    ...
    "The Implementer Handoff Prompt is intentionally basic and may need expansion in later Work Cards.",
  ],
  implementerInstructions: [
    "Verify the repository path before editing.",
    "Read `AGENTS.md`, the latest Implementer Report, and `planning/project/WORK_CARD_BACKLOG.md` before implementation.",
    "Keep the pass limited to Work Card schema, validation, rendering, fixture, validation script, phase folder convention, rendered Work Card artifact, and Implementer Report.",
