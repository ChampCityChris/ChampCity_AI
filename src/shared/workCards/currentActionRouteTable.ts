...
export const currentActionSurfaceRoutes = [
  ...
  route("repository_reconciliation_required", "architect", "repository-reconciliation", "repository-reconciliation", ["repositoryReconciliation:previewPrompt", "repositoryReconciliation:preview", "repositoryReconciliation:save"], "project", "project planning bundle", "reconciliation_review"),
  route("reconciliation_review_required", "architect", "repository-reconciliation", "repository-reconciliation", ["repositoryReconciliation:previewPrompt", "repositoryReconciliation:preview", "repositoryReconciliation:save"], "project", "project planning bundle", "reconciliation_review"),
  route("project_mapping_required", "architect", "project-mapping", "project-roadmap", ["projectRoadmap:preview", "projectRoadmap:save"], "project", "project intake/interview/reconciliation", "project_roadmap"),
  ...
  route("project_roadmap_required", "architect", "project-mapping", "project-roadmap", ["projectRoadmap:preview", "projectRoadmap:save"], "project", "project planning bundle", "project_roadmap"),
  route("operator_project_approval_required", "operator", "operator-project-approval", "project-planning-documents", [], "project planning", "project planning bundle", "operator_approval"),
  ...
  route("operator_phase_approval_required", "operator", "operator-phase-approval", "phase-planning-documents", [], "phase planning", "phase map/planning/work-card plan", "operator_approval"),
  ...
  route("operator_work_card_approval_required", "operator", "operator-work-card-approval", "work-card-plan-review", [], "work_card", "work_card", "operator_approval"),
  route("operator_work_card_review_required", "operator", "operator-work-card-approval", "work-card-plan-review", [], "work_card", "work_card", "operator_approval"),
  ...
  route("architect_review_of_validation_report_required", "architect", "architect-bridge", "architect-bridge", ["workCards:ensureArchitectTaskPacket"], "work_card", "operator_validation", "candidate_disposition"),
  route("operator_validation_required", "operator", "operator-validation", "human-validation", ["workCards:previewHumanValidationRecord", "workCards:saveHumanValidationRecord", "workCards:attachValidationEvidenceFile"], "work_card", "architect_review and implementation evidence", "operator_validation"),
  route("architect_disposition_required", "architect", "architect-bridge", "architect-bridge", ["workCards:ensureArchitectTaskPacket"], "work_card", "validation report and repair evidence bundle", "candidate_disposition"),
  ...
  route("repair_validation_required", "operator", "operator-validation", "human-validation", ["workCards:previewHumanValidationRecord", "workCards:saveHumanValidationRecord", "workCards:attachValidationEvidenceFile"], "repair work_card", "repair architect review and evidence", "operator_validation"),
  ...
  route("operator_phase_closeout_approval_required", "operator", "operator-closeout-approval", "phase-closeout", [], "phase_closeout", "phase_closeout", "operator_approval"),
  route("operator_closeout_approval_required", "operator", "operator-closeout-approval", "phase-closeout", [], "phase_closeout", "phase_closeout", "operator_approval"),
  route("roadmap_update_required", "architect", "roadmap-update", "project-planning-documents", ["projectRoadmap:preview", "projectRoadmap:save"], "project_roadmap", "phase closeout approval", "project_roadmap"),
