...
export const currentActionSurfaceRoutes = [
  ...
  route("architect_review_of_validation_report_required", "architect", "architect-bridge", "architect-bridge", ["workCards:ensureArchitectTaskPacket"], "work_card", "validation_report", "candidate_disposition"),
