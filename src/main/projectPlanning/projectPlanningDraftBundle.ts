...
function buildProjectPlanningPreparedInstruction(
  ...
  return [
    ...
    `- Architect Interview Prompt Markdown (provenance/contract evidence): ${context.prompt.markdownPath}`,
    ...
    `- Repository review context: ${context.repositoryReviewContext || "none provided"}`,
    "",
    "Inspect required repository evidence through ChampCity MCP before drafting outputs.",
    "When repository review context is present, use it to identify and inspect the materially relevant evidence before drafting; do not treat it as decorative context.",
    "Treat the approved Project Intake, approved Architect Interview, and materially relevant governing product evidence as semantic planning evidence. The approved Architect Interview is the primary semantic synthesis; the prior Interview Prompt is provenance and contract evidence and should be inspected semantically only when needed to resolve a contradiction or ambiguity.",
    ...
    "Plan on two simultaneous axes: architecture or migration requirements, and product or Operator capability requirements. Neither axis may silently erase the other.",
    ...
    "Do not assume an MVP. Use MVP framing only when the approved project evidence explicitly establishes an MVP, proof-of-concept, first-product validation boundary, or equivalent delivery concept.",
    "For an existing system, treat current implemented behavior as the functional baseline unless the approved project evidence explicitly deprecates or changes it.",
    "For existing-product refactor, migration, platform-transition, feature-expansion, or capability-extraction work, plan the architectural foundation, coherent operational migration or implementation slices, behavior preservation, compatibility boundaries, dependencies, and cutover criteria.",
    "Do not add product-validation, proof-of-concept, prototype, viability, or market-validation work merely because an MVP template or legacy heading exists.",
    "",
    ...
    "The required MVP Scope and Post-MVP Roadmap headings are legacy V1 structural labels and do not establish MVP semantics.",
    "When MVP framing is established by the approved project evidence, use those headings literally.",
    "When MVP framing is not established, use MVP Scope for the primary bounded delivery, migration, or refactor scope, and use Post-MVP Roadmap for subsequent lifecycle work after that primary scope.",
    "The Roadmap must cover the complete currently intended development lifecycle beyond the primary bounded delivery slice.",
    "For every material product capability or workflow established by the approved Project Intake, approved Architect Interview, or materially relevant governing product evidence, the Roadmap must do exactly one of the following: sequence it into a specific roadmap phase or outcome; explicitly defer it with rationale; explicitly supersede it with the governing replacement decision; or mark it conditional and state the condition. Silent omission is prohibited.",
    "Use the existing Work-State Classification, Sequenced Roadmap, and Deferred and Conditional Work sections for capability disposition; do not add a new required heading.",
    "Distinguish a user or product capability--what the Operator or product can materially do--from an internal service, interface, adapter, or other enabling boundary. Creating a MemoryService, RepositoryService, runtime adapter, or equivalent internal boundary does not by itself prove delivery of the corresponding capability unless the Roadmap identifies the consuming behavior or outcome.",
    "Each project phase must identify, when applicable, both the architecture or migration boundary established or changed and the meaningful product or Operator capability that becomes new, materially improved, or operationally usable after the phase. An internal abstraction or service boundary alone is not automatically a sufficient project-level phase outcome.",
    ...
    "For an existing-product migration or refactor that introduces a materially new deployment mode or major capability, exercise that capability through a real consuming vertical slice as early as architecture dependencies safely permit. Do not build every hypothetical portability abstraction first and postpone the first real consumer until the end merely for architectural purity.",
    ...
    "Sequence every known major workstream from the approved evidence, or explicitly defer, supersede, or condition it at the level supported by current evidence.",
