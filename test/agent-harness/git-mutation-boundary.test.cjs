...
test("generic source completion checkpoints only attributed files on the Intake branch and keeps remote failure separate", async (t) => {
  ...
  writeDoc(root, contractPath, "formal-work-card", "Approved", { identity: { intakeId: intake.intakeId, workCardId: "WI01" }, sourceRevisions: [{ path: intake.relativePath, revision: 1 }], bodyMarkdown: "# WI01\n\nImplement the bounded correction." });
  writeDoc(root, reportPath, "implementer-report", "Pending", { identity: { intakeId: intake.intakeId, workCardId: "WI01" }, sourceRevisions: [{ path: contractPath, revision: 1 }], bodyMarkdown: "# Report\n\nReserved." });
